...
plot_map <- function(data,
  ...
  if (Europe_crop == TRUE &
      first(data$map_level, na_rm = TRUE) == "continent" &
      first(data$map_region, na_rm = TRUE) == "Europe")
  {
  ...
  if (first(data$map_level, na_rm = TRUE) == "country")
  {
  ...
  if (div_type == "spec_occ") {
    ...
    if (surround == TRUE & first(data$map_level, na_rm = TRUE) == "country") {
