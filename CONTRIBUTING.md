# Contributing to b3gbi

This outlines how to propose a change to b3gbi. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("b-cubed-eu/b3gbi", fork = TRUE)`.
...
Please note that the b3gbi project is released with a [Contributor Code
of Conduct](https://b-cubed-eu.github.io/b3gbi/CODE_OF_CONDUCT.md). By
