...
#                 manually specify 'eea', 'mgrs', or 'eqdgc'. If you are using 
#                 a simulated cube. e.g. output by the gcube package, choose 
#                 'custom'.
...
# processed_cube object. Should be called by one of the wrapper functions listed 
# below. 
#
# Inputs: 
...
#                  rnaturalearth. Defaults to FALSE. Alternatively you can set 
#                  it to "buffered_coast" to set a buffer distance around land.
