...
#   * Argument 4: ci_type, type of bootstrap confidence intervals to calculate (norm, basic, perc, bca, none). Uses 'norm' by default.
...
#   * Argument 8: output_crs (optional), the projection to use for your calculated indicator if you don't want the default.
#   * Argument 9: first_year (optional), use to limit the data used to calculate the indicator to a narrower range than the cube
#   * Argument 10: last_year (optional), see first_year
#   * Argument 11: spherical_geometry (optional), if FALSE, temporarily turn off spherical geometry when calculating indicator
#   * Argument 12: make_valid (optional), call st_make_valid from the sf package to fix geometry issues if you are getting errors
# Outputs:
