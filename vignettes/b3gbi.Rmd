...
#                  default.
#   * Argument 16: crs_unit_convert, force an output crs with different units
#                  than the input crs. FALSE by default.
#   * Argument 17: shapefile_path, path to an external shapefile you want to
...
#                  rnaturalearth. Defaults to TRUE. Alternatively you can set it
...
#   * Argument 21: layers, names of additional rnaturalearth layers to include
#
# Outputs:
