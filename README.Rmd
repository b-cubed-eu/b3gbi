...
* **Flexibility:**  Calculate richness, evenness, rarity, taxonomic distinctness, Hill-Shannon diversity, Hill-Simpson diversity, completeness, and more.
...
This basic example demonstrates the core workflow: preparing the data cube, calculating an indicator, and plotting the result as a spatial map of species richness for bryophytes in Montenegro.
