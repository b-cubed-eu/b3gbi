...
Release (COL XR) for alphanumeric keys. All taxa are looked up in a
single batched request, and the results are cached for the rest of the R
session. This requires the rgbif package and an internet connection.
