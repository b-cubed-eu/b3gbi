...
#'
#' @param cellCode A character vector of EQDGC cell codes giving the
#'   longitude and latitude of a 1-degree cell (e.g. "E009N57" or "W010S34"),
#'   optionally followed by up to six letters A-D for sub-cells (e.g.
#'   "E009N57DD" = 0.25 degree cell).
#'
