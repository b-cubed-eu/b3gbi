...
#' @export
#' @rdname calc_ci
calc_ci.obs_richness <- function(x,
                                 indicator,
                                 num_bootstrap = 1000,
                                 ci_type = ci_type,
                                 ...) {
...
#' @export
#' @rdname calc_ci
calc_ci.cum_richness <- function(x,
                                 indicator,
                                 num_bootstrap = 1000,
                                 ci_type = ci_type,
                                 ...) {
  ...
  warning("No confidence intervals are calculated for this indicator type.")
...
#' @export
#' @rdname calc_ci
calc_ci.occ_turnover <- function(x,
                                 indicator,
                                 num_bootstrap = 1000,
                                 ci_type = ci_type,
                                 ...) {
