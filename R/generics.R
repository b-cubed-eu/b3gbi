...
#' @export
print.indicator_ts <- function(x, n = 10, useS4 = FALSE) {
...
#' @export
print.indicator_map <- function(x, n = 10, useS4 = FALSE) {
...
#' @export
print.processed_cube <- function(x, n = 10, useS4 = FALSE) {
...
#' @export
print.processed_cube_dsinfo <- function(x, n = 10, useS4 = FALSE) {
  cat("\nProcessed data cube for calculating biodiversity indicators.\n\n")
  cat("Date Range:", x$first_year, "-", x$last_year, "\n")
